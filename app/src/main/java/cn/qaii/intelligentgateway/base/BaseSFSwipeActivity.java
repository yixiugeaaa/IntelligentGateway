...
import cn.qaii.viewutil_lib.swipe.back.SwipeBackActivity;
 ...
 *
 */
public class BaseSFSwipeActivity extends SwipeBackActivity {
	...
	private void initActionBar() {
		if (getSupportActionBar() != null) {
			...
			mActionBar.setCustomView(R.layout.view_actionbar_sf); 
			...
			mShareView = (ImageView)mActionBar.getCustomView().findViewById(R.id.btn_share);
			mFavoriteView = (ImageView)mActionBar.getCustomView().findViewById(R.id.btn_favorite);
